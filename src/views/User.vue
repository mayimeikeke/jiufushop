    ...
    <div class="main">
      ...
      <section class="my-vip">
        <router-link class="my-vip-top ho" :to="{ name: '' }">
          ...
          <p><span>会员福利</span><i class="icon-go"></i></p>
        </router-link>
        <router-link class="my-vip-bottom ho" :to="{ name: '' }">
          <div>
            <span class="icon2-money"></span>
          </div>
          <p><span>我的优惠</span><i class="icon-go"></i></p>
        </router-link>
      </section>
      ...
      <section class="my-service">
        <router-link class="my-service-top" :to="{ name: '' }">
          ...
          <p><span>服务中心</span><i class="icon-go"></i></p>
        </router-link>
        <router-link class="my-service-bottom" :to="{ name: '' }">
          <div>
            <span class="icon2-money"></span>
          </div>
          <p><span>电商之家</span><i class="icon-go"></i></p>
        </router-link>
      </section>
      ...
      <section class="my-settle">
        <router-link :to="{ name: '' }" class="my-settle-top">
          ...
          <p><span>F码通道</span><i class="icon-go"></i></p>
        </router-link>
        <router-link :to="{ name: '' }" class="my-settle-bottom">
          <div>
            <span class="icon2-settle"></span>
          </div>
          <p><span>设置</span><i class="icon-go"></i></p>
        </router-link>
      </section>
    </div>
...
.car {
  ...
  .header {
    width: 100%;
    height: 16vw;
    background: url(../../static/carbg.png) center 0 #ee4423;
